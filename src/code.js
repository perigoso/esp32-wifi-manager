...
docReady(async function () {
  ...
  gel("yes-disconnect").addEventListener("click", async () => {
    ...
    await fetch(window.location.pathname + "/connect.json", {
      method: "DELETE",
      headers: {
...
async function refreshAP(url = window.location.pathname + "/ap.json") {
  try {
...
async function checkStatus(url = window.location.pathname + "/status.json") {
  try {
